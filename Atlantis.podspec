Pod::Spec.new do |spec|
  ...
  # Consumed by tag: the fork publishes the terminus-1.0.1 release tag. s.version (1.1.1)
  # is a valid CocoaPods semver; the tag is pinned explicitly since it is not equal to it.
  spec.source       = { :git => "https://github.com/HeiCg/atlantis.git", :tag => "terminus-1.0.1" }
